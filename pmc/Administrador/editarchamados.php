					...
					<div class="campo">
						<label for=tpReparo>Qual tipo de reparo:</label>
							...
							<?php $tr = $row['tpReparo'];?>
								...
								<option value="3" <?php echo selected( '3', $tr ); ?>>Reparo de Internet</option>
								<option value="4" <?php echo selected( '4', $tr ); ?>>Outros</option>
							</select>
					</div>
					<div class="campo">
...
<footer class="footer">
			<i class="bi bi-code-slash"></i> Developed by: <a href="https://github.com/Ian-Alexandre" target="_blank" class="dev-link">Ian Alexandre</a>
		</footer>
</html>
